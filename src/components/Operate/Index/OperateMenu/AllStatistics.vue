    ...
    <div class="all">
      <div class="expenseCalendar">
        ...
        <el-row class="secondRowData">
          ...
          <el-col :span="4">
            <div class="topTitle">核验总数</div>
            <span class="bottomData">{{countObj.summary}}</span>
          </el-col>
          <el-col :span="4">
            <div class="topTitle">有证身份核验</div>
            <span class="bottomData">{{countObj.license_summary}}</span>
          </el-col>
          <el-col :span="4">
            <div class="topTitle">无证身份核验</div>
            <span class="bottomData">{{countObj.nolicense_summary}}</span>
          </el-col>
          <el-col :span="4">
            <div class="topTitle">有证核验占比</div>
            <span class="bottomData">{{countObj.license_percent}}</span>
          </el-col>
          <el-col :span="4">
            <div class="topTitle">无证核验占比</div>
            <span class="bottomData">{{countObj.nolicense_percent}}</span>
          </el-col>
        </el-row>
        <div class="myChart11">
          <div class="myChartLeft">
            <div class="pass"><p></p>有证身份核验</div>
            <div class="noPass"><p></p>无证身份核验</div>
          </div>
