  ...
  <div class="establishContent">
    ...
    <el-form :model="contentForm" :rules="rules" ref="contentForm" label-width="100px" class="demo-ruleForm">
      ...
      <el-form-item label="省/市/区" prop="selectedOptions">
        <el-cascader size="large" :options="options" v-model="contentForm.selectedOptions"
                     @change="handleChange">
        </el-cascader>
      </el-form-item>
      <el-form-item label="地址" prop="address" class='addressDetail'>
        <el-input v-model="contentForm.address" autocomplete="off" id="suggestId"
                  name="address_detail"></el-input>
  ...
  export default {
    ...
    methods: {
      ...
      initEditor:function () {
        ...
        this.editor.customConfig.uploadImgServer = '/galaxy-front/adv/picture/upload'
        ...
        this.editor.customConfig.onchange = (html) => {
          this.contentForm.introduceMsg = html;
        }
      ...
      //   this.saveintroduceMessage = render + '&&&$$$' + value
      // },
      //编辑上传图片
      // $imgAdd(pos, $file) {
      //   var that = this
      ...
      SaveContentForm(formname) {
        var that = this
        that.contentForm.introduceMsg=this.editor.txt.html();
